classdef Fung2013 < handle & matlab.mixin.Heterogeneous & matlab.mixin.Copyable
    ...
    methods (Static)
        function globbed = createFromCoords(varargin)
            ...
            %      coords (struct): e.g., 
            %          t1w: left:  coord1: [1 2 3], coord2: [4 5 6], 
            %               right: coord1: [7 8 9], coord2: [10 11 12], 
            %          tof: left:  coord1: [101 102 103], coord2: [104 105 106], 
            %               right: coord1: [107 108 109], coord2: [110 111 112].
            %  Returns:
            ...
            for h = {'left', 'right'}
                f = Fung2013.createForT1w( ...
                    'coord1', ipr.t1w.(h{1}).coord1, 'coord2', ipr.t1w.(h{1}).coord2, ...
            ...
            for h = {'left', 'right'}
                f = Fung2013.createForTof( ...
                    'coord1', ipr.tof.(h{1}).coord1, 'coord2', ipr.tof.(h{1}).coord2, ...
                    'use_cache', true, varargin{:});
                for g = globbed
                    call(f, 'pet_dyn', g{1});
                end
